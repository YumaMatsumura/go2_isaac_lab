...
class Go2ParkourWalkCommandsCfg(CommandsCfg):
    ...
    def __post_init__(self):
        ...
        self.base_velocity.ranges.lin_vel_x = (-0.1, 0.1)
        self.base_velocity.ranges.lin_vel_y = (-0.1, 0.1)
        self.base_velocity.ranges.ang_vel_z = (-1.0, 1.0)
        self.base_velocity.ranges.heading = (-math.pi, math.pi)
        self.base_velocity.limit_ranges.lin_vel_x = (-0.4, 0.6)
        self.base_velocity.limit_ranges.lin_vel_y = (-0.4, 0.4)
        self.base_velocity.limit_ranges.ang_vel_z = (-1.0, 1.0)
        self.base_velocity.limit_ranges.heading = (-math.pi, math.pi)
...
class Go2ParkourCrouchCommandsCfg(CommandsCfg):
    ...
    def __post_init__(self):
        ...
        self.base_velocity.heading_command = False
        self.base_velocity.ranges.lin_vel_x = (0.0, 0.3)
        self.base_velocity.ranges.lin_vel_y = (-0.1, 0.1)
        self.base_velocity.ranges.ang_vel_z = (-0.5, 0.5)
        self.base_velocity.limit_ranges.lin_vel_x = (-0.3, 0.5)
...
class Go2ParkourCrouchRewardsCfg(RewardsCfg):
    ...
    def __post_init__(self):
        ...
        self.energy.weight = -2e-5  # 消費電力が多いとペナルティが与えられる
        self.joint_pos.weight = -0.05  # 標準姿勢から大きく崩れるとペナルティが与えられる
        self.feet_air_time.weight = 0.1  # 脚が適切に地面から離れると報酬が与えられる
        self.air_time_variance.weight = -1.0  # 左右のスイング時間がバラバラだとペナルティが与えられる
        self.feet_slide.weight = -0.1  # 脚が接地しているのに滑るとペナルティが与えられる
        self.undesired_contacts.weight = -1.0  # 頭や太ももなどが地面に接触するとペナルティが与えられる
        self.crouch_height.weight = 0.5  # 目標の高さから遠ざかるとペナルティが与えられる
