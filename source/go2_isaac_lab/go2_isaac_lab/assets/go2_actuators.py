...
class Go2Actuator(DelayedPDActuator):
    ...
    def __init__(self, cfg: Go2ActuatorCfg, *args, **kwargs):
...
@configclass
class Go2ActuatorCfg(DelayedPDActuatorCfg):
    """
    Configuration for Unitree actuators.
    """

    class_type: type = Go2Actuator
